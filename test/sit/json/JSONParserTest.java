...
public class JSONParserTest {
    ...
    private static void testSpecialChars(String value) {
        JSONObject specialCharTest = new JSONObject("blubber");
        specialCharTest.setValue(value, true);
        System.out.println(value + " --> " + specialCharTest.toJson());
    }
    ...
    public static void main(String[] args) {
        ...
        String case1 = "aaaa\\bbbb";
        String case2 = "aaaa\"bbbb";
        String case3 = "aaaa\"\\\"bbbb";
        testSpecialChars(case1);
        testSpecialChars(case2);
        testSpecialChars(case3);
